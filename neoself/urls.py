...
urlpatterns = [
    ...
    path('user/self/', views.UserSelfDetail.as_view(), name='user-detail'),
    ...
    path('recent/reflection/<int:id>/', views.RecentReflectionList.as_view(), name="dont-care"),
    ...
    path('like/<int:pk>/', views.RecordLikeDetail.as_view(), name="like-detail"),
]
